...
import { ChevronRight, MessageCircle, Phone, Mail, Key, Percent, Wallet, AlertTriangle, Lightbulb } from 'lucide-react';
...
export default function PurposeCalc() {
  ...
  const handleSendEmail = () => {
    ...
    const subject = encodeURIComponent('חישוב הלוואה לכל מטרה — איתנות פיננסית');
    const body = encodeURIComponent(
      `שלום,\n\nלהלן תוצאות חישוב ההלוואה לכל מטרה:\n\n` +
      (name  ? `שם: ${name}\n`   : '') +
      (phone ? `טלפון: ${phone}\n` : '') +
      ...
      `⚠️ החישוב מבוסס על ריביות משוערות בלבד.\n\n` +
